...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_container2.default, null), document.querySelector('#test'));
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleChange(newVal) {
	            ...
	            this.setState({
	                ...
	                _this2.props.onChange && _this2.props.onChange(newVal);
	            });
	        }
	    }, {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var controlledValue = nextProps.defaultValue;

	            if (controlledValue !== undefined && controlledValue !== this.state.value) {
	                this.setState({
	                    value: controlledValue
	                }, function () {
	                    _this3.props.onChange && _this3.props.onChange(controlledValue);
	                });
	            }
	        }
	    }, {
	        ...
	        key: 'mapPropToState',
	        value: function mapPropToState(controlledValue) {
